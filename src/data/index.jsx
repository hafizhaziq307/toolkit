...
export const tools = [
    {
        ...
        icon: <TbAlignJustified strokeWidth={1.5} className="h-7 w-7 text-amber-500" />,
    },
    {
        id: 1,
        ...
        icon: <TbAlignJustified strokeWidth={1.5} className="h-7 w-7 text-rose-500" />,
    },
    {
        id: 2,
        ...
        icon: <TbLetterCase strokeWidth={1.5} className="h-7 w-7 text-teal-500" />,
    },
    {
        id: 3,
        ...
        icon: <TbQrcode strokeWidth={1.5} className="h-7 w-7 text-sky-500" />,
    },
    {
        id: 4,
        ...
        icon: <TbColorSwatch strokeWidth={1.5} className="h-7 w-7 text-emerald-500" />,
    },
    {
        id: 5,
        ...
        icon: <TbBrush strokeWidth={1.5} className="h-7 w-7 text-indigo-500" />,
    },
    {
        id: 6,
        title: "gear calc",
        ...
        icon: <TbCalculator strokeWidth={1.5} className="h-7 w-7 text-fuchsia-500" />,
    },
    {
        id: 7,
        title: "excel to SQL",
        ...
        icon: <TbFileText strokeWidth={1.5} className="h-7 w-7 text-lime-500" />,
    },
    {
        id: 8,
        title: "SQL Formatter",
...
export const tags = [
    {
        id: 0,
        title: "all",
        icon: <TbTags strokeWidth={1.5} className="h-6 w-6" />,
    },
    {
        id: 1,
        title: "text",
        icon: <TbAlignJustified strokeWidth={1.5} className="h-6 w-6" />,
    },
    {
        id: 2,
        title: "color",
        icon: <TbColorSwatch strokeWidth={1.5} className="h-6 w-6" />,
    },
    {
        id: 3,
        title: "qr code",
        icon: <TbQrcode strokeWidth={1.5} className="h-6 w-6" />,
    },
    {
        id: 4,
        title: "sql",
        icon: <TbDatabase strokeWidth={1.5} className="h-6 w-6" />,
    },
    {
        id: 5,
        title: "math",
        icon: <TbCalculator strokeWidth={1.5} className="h-6 w-6" />,
    },
];
